...
flags.DEFINE_bool('save_anim', True, 'Save an animation of eval trajectories')
...
flags.DEFINE_float('log_every', 2e6, 'Log every n frames')
flags.DEFINE_float('save_every', 4e6, 'Save every n frames')
